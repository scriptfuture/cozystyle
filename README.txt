...
1. Установка npm-модулей
   -зайти в корневую директорию проекта через консоль
   -ввести "npm install"
   -удостоверится что gulp установлен глобально, ввести "gulp -v" (если система не найдет такой программы, установить gulp глобально "npm install gulp -g")
2. Создание сборки проекта (минификация исходных файлов)
   gulp minify
